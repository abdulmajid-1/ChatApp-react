...
const ChatContainer = ({ selectedUser, setSelectedUser }) => {
  ...
  return selectedUser ? (
    <div className="h-full overflow-scroll relative backdrop-blur-lg">
      {/* header */}
      <div
        className="flex items-center gap-3 py-3 mx-4 
      ...
      <div
        ...
        h-[calc(100%-120px)] overflow-y-scroll p-3 pb-6"
      >
        {messagesDummyData.map((msg, index) => (
          <div
            ...
            className={`
                ...
                ${
                  msg.senderId !== "680f50e4f10f3cd2838ecf9" &&
                  "flex-row-reverse"
                }`}
          >
            {msg.image ? (
    ...
    >
      <img src={assets.logo_icon} className="m-w-16" alt="" />
